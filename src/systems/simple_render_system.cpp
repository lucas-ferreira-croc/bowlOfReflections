...
namespace bor
{
    ...
    BoRSimpleRenderSystem::BoRSimpleRenderSystem(BoRDevice& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout)
        : borDevice{device}
    {
    ...
    void BoRSimpleRenderSystem::createPipelineLayout(VkDescriptorSetLayout globalSetLayout)
    {
