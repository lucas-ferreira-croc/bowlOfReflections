...
namespace bor
{
    ...
    void BoRPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
    {
        ...
        configInfo.bindingDescription = BoRModel::Vertex::getBindingDescriptions();
        configInfo.attributeDescription = BoRModel::Vertex::getAttributeDescriptions();
    }
